...
import {REGISTER_STEP_2_URL, ERROR_MESSAGES} from '../../config/configuration';
...
import {  FETCH_CATEGORY_URL } from '../../config/configuration';
...
class RegisterStep2 extends Component {
    constructor(props) {
        ...
        this.selectedCategory = this.props.user.categories;
        ...
        if (this.state.isActive < 1) {
            ...
            sendPostRequest(REGISTER_STEP_2_URL, {
                ...
                if(res.status == 200) {
                    ...
                    this.setState({isLoading: false});
                    showMessage('success', ERROR_MESSAGES.SOMETHING_WENT_WRONG);
                    throw new Error();
                }
                        ...
                        <div class="profilePic">
                            ...
                            <div class="form-group stepTop">
                                ...
                                <p><div class="form-group stepTop">
                                    <label for="comment">Tell us more about you</label>
                                    <div class="rel">   
                                    <textarea class="input" rows="5" value={this.state.description} onChange={(e)=>{this.onInputChange(e, 'description')}}></textarea>
                                    <span class="border"></span>
                                </div>
                                </div></p>
                            </div>
                            ...
                            <p><input placeholder="Username..." oninput="this.className = ''" name="uname" /></p>
                                ...
                                <div class="btnGroup">
                                    ...
                                    <button class="lightBlue hvr-grow-shadow" type="button" id="nextBtn" onClick={(e) => { this.onNext() }}>{(this.state.isActive == 1) ? 'Save' : 'Next'}</button>
                                </div>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RegisterStep2));
